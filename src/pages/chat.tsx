...
export default function Chat() {
  ...
  // If auth is still loading, show minimal loading state
  if (!isLoaded) {
    return (
      <div className="flex min-h-screen bg-pastel-green items-center justify-center">
        <div className="text-mint-green">Loading...</div>
      </div>
    );
  }
  
  return (
    <div className="flex min-h-screen bg-pastel-green">
      <ChatSidebar 
